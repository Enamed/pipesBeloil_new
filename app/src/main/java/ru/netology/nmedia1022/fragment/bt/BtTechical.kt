...
//                    )).toString()
                ...
                val zamokLm = if (post?.priznak == "BT") {
                    when (post?.narDiametrZamka) {
                        "77", "85.7", "86", "92" -> "160.0"
                        "95" -> "125.0"
                        "105.5", "105", "104.8", "108" -> "190.0"
                        "121", "127", "133", "139.7", "140", "152", "158.8", "159", "161.9", "162",
                        "165", "168", "168.3", "177", "177.8", "178", "184", "184.1" -> "200.0"
                    ...
                    when (post?.pin) {
                        ...
                        "З-73" -> "170.0"
                        "З-86" -> "180.0"
                        "З-102", "З-108", "З-133", "З-147", "З-152", "З-171" -> "200.0"
                        "З-177" -> "210.0"
                        else -> "См. ТП НБС"
                    }
                } else {
